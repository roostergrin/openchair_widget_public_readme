...
| policyCheckbox      | String           | Add a checkbox to the widget for users to agree to the privacy policy. Defaults to 'required'.                                                                                                                                                                 |
| policyCheckboxRequired      | Boolean           | If you're using policyCheckbox, include this with a value of false to make it not required.                                                                                                                                                                 |
